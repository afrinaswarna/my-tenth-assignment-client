...
"devDependencies": {
  ...
  ## Our technologies:
These are the main technologies and frameworks/libraries that we use in our project:
1.React.js – JavaScript library for building user interfaces
2.Tailwind CSS – Utility-first CSS framework for styling
3.DaisyUI – Tailwind CSS component library for faster UI design
4.React Router – Library for navigation and routing in React apps
5.Recharts – Charting library for building data visualizations
6.React Toastify – Library for showing toast notifications
6.React Icons – Icon library for React components
7.Express.js-for creating server
8.Mongodb-for connecting database
