...
<div className="card bg-base-100  shadow-sm">
      ...
      {
        property.property_status ==='Available'?<><div className="badge badge-success">Available</div></>:property.property_status ==='Rented'?<><div className="badge badge-secondary">Rented</div></>:<><div className="badge badge-warning">Sold</div></>

      } 
      
    </div>
       <p className='text-gray-500 text-sm font-medium'><span className='font-bold text-gray-600'>Owner:</span>{property.posted_by}</p>
